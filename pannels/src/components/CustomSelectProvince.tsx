...
const CustomSelectProvince: React.FC<FieldAttributes<any>> = ({
  calculateOptions,
  defaultValue,
  label,
  field, // { name, value, onChange, onBlur }
  form: { touched, errors,initialValues, setFieldValue, setFieldTouched }, // also values, setXXXX, handleXXXX, dirty, isValid, status, etc.
}) => {
  ...
  axiosInstance.get('/Province/').then(({data})=>   
      { 
...
export default CustomSelectProvince;
